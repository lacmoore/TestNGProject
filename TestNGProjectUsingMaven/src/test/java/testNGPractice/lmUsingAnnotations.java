...
public class lmUsingAnnotations {
	
//	Feature	WebDriverWait													Thread.sleep
//	Type	Explicit wait (smart wait)										Hard-coded wait
//	Purpose	Wait until a specific condition is met							Pause execution for a fixed time
//	Flexibility	Waits up to a max time, exits early if condition is met		Always waits the full time
